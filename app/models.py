...
class Question(models.Model):
    ...
    post_image = models.CharField(max_length=255, null=True)
    post_audio = models.CharField(max_length=255, null=True)
    post_video = models.CharField(max_length=255, null=True)
